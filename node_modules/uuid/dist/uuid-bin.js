...
import v1 from 'uuid/dist/v1.js';
import v3 from 'uuid/dist/v3.js';
import v4 from 'uuid/dist/v4.js';
import v5 from 'uuid/dist/v5.js';
import v6 from 'uuid/dist/v6.js';
import v7 from 'uuid/dist/v7.js';
function usage() {
    console.log('Usage:');
    console.log('  uuid');
    console.log('  uuid v1');
