...
import v1 from 'uuid/dist-node/v1.js';
import v3 from 'uuid/dist-node/v3.js';
import v4 from 'uuid/dist-node/v4.js';
import v5 from 'uuid/dist-node/v5.js';
import v6 from 'uuid/dist-node/v6.js';
import v7 from 'uuid/dist-node/v7.js';
function usage() {
    console.log('Usage:');
    console.log('  uuid');
    console.log('  uuid v1');
